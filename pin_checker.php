	...
	<div class="body">
		<form method="post" action="#" id="form1">
			<fieldset border=1>
				...
				<legend><h2 align="center" id="s">Pin Checker</h2></legend>
				<p>	<h3 align="center">
					Confirm whether your pin is genuine.<br><br>
					
					<label for="pin">Pin:-</label><input type="text" name="pin" style="border-radius: 5px 5px 5px 5px">
					<br><br>
					<div class="f11">
			...
			<a href="index2.php"><button class="btn btn-default"><span class="badge">Home</span></button></a>
